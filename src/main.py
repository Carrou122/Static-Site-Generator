    ...
    for item in os.listdir(dir_path_content):
        ...
        if os.path.isfile(current_item_path):
            if current_item_path.endswith(".md"):
                ...
                generate_page(current_item_path, template_path, dest_path_final, basepath)
            else:
                continue
        else:
            generate_pages_recursive(current_item_path, template_path, os.path.join(dest_dir_path, item), basepath)
